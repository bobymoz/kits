...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CategoryController')->prefix('category')->name('category.')->group(function () {
        ...
        //Manage File Formats
        Route::get('sc/file-formats/{id}', 'formats')->name('subcategory.file.format');
        Route::post('subcategory/file-format/store/{id?}', 'formatStore')->name('subcategory.format.store');
        Route::post('subcategory/file-format/status/{id}', 'formatStatus')->name('subcategory.format.status');
    });
    ...
    Route::controller('ProductController')->prefix('product')->name('product.')->group(function () {
        ...
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
        Route::get('get/formats/{id}', 'getFormats')->name('formats');
