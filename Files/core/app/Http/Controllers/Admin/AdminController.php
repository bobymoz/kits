...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $product['total_product']      = Product::count();
        $product['total_paid_product'] = Product::where('type', Status::PRODUCT_PAID)->count();
        $product['total_free_product'] = Product::where('type', Status::PRODUCT_FREE)->count();
        $product['total_category']     = Category::count();

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart','deposit', 'product'));
    }
