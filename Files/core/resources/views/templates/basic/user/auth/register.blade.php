                ...
                <div class="col-md-10 col-lg-8 col-xl-6">
                    <div class="account__wrapper bg--section @if (!gs('registration')) form-disabled @endif">
                        ...
                        <form class="account-form verify-gcaptcha disableSubmission" action="{{ route('user.register') }}" method="POST">
                            ...
                            @endif
                            <div class="form-group">
                                <button class="btn cmn--btn justify-content-center w-100" id="recaptcha" type="submit"> @lang('Sign Up')</button>
                            </div>
                            <p class="mt-3">@lang('Already have an account?') <a href="{{ route('user.login') }}">@lang('Sign In')</a></p>
                        </form>
                    </div>
                </div>
            </div>
