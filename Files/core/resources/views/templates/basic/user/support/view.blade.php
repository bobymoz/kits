                ...
                <form method="post" class="disableSubmission" action="{{ route('ticket.reply', $myTicket->id) }}"
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="mb-2 mt-3"><span class="text--info">@lang('Max 5 files can be uploaded | Maximum upload size is ' . convertToReadableSize(ini_get('upload_max_filesize')) . ' | Allowed File Extensions: .jpg, .jpeg, .png, .pdf, .doc, .docx')</span></p>
                            <div class="row fileUploadsContainer">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <button class="btn cmn--btn justify-content-center w-100 my-2" type="submit"><i
                                    ...
                                    <div class="mt-2">
                                        @foreach ($message->attachments as $k => $image)
                                            <a href="{{ route('ticket.download', encrypt($image->id)) }}" class="me-3"><i
                                                   class="fa-regular fa-file"></i> @lang('Attachment')
                                                {{ ++$k }} </a>
                                        @endforeach
                                    </div>
                                @endif
        ...
        (function($) {
            ...
            $('.addAttachment').on('click', function() {
                ...
                $(".fileUploadsContainer").append(`
                    <div class="col-lg-4 col-md-12 pt-3 removeFileInput">
                        <div class="form-group">
