        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    ...
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            <a href="{{ route('admin.product.index') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="lab la-product-hunt"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{  $product['total_product'] }}</h6>
                                    <p class="widget-card-title">@lang('Total Product')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--warning">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{  $product['total_category'] }}</h6>
                        ...
                        <div class="widget-card bg--danger">
                            <a href="{{ route('admin.product.index') }}?search=&type={{ Status::PRODUCT_PAID }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-file-invoice-dollar"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{  $product['total_paid_product'] }}</h6>
                                    <p class="widget-card-title">@lang('Total Paid Product')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--primary">
                            <a href="{{ route('admin.product.index') }}?search=&type={{ Status::PRODUCT_FREE }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="lab la-free-code-camp"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{  $product['total_free_product'] }}</h6>
                                    <p class="widget-card-title">@lang('Total Free Product')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
