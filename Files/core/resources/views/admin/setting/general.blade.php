                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-3 col-sm-6">
                                <label class="required"> @lang('Theme Mode')</label>
                                <select class="select2 form-control" name="theme_mode" data-minimum-results-for-search="-1">
                                    <option value="1" @selected(gs('theme_mode') == 1 )>@lang('Dark')</option>
                                    <option value="0" @selected(gs('theme_mode') == 0 )>@lang('Light')</option>
                                </select>
                            </div>
                            <div class="form-group col-xl-3 col-sm-6">
