...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="disableSubmission" method="POST" action="{{ route('admin.product.page.update.seo', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <label>@lang('SEO Image')</label>
                                    <x-image-uploader class="w-100" :imagePath="frontendImage('product',@$data->seo_content->image,getFileSize('seo'),true)" :size="getFileSize('seo')" :required="false" />
                                </div>
                            </div>
